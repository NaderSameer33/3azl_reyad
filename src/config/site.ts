...
export const siteConfig = {
  ...
  description: {
    ar: "شركة المعمورة للمقاولات العامة والعوازل بالرياض. أفضل خدمات عزل الفوم، المائي والحراري، عزل الخزانات وكشف تسربات المياه بأحدث الأجهزة وضمان معتمد. اتصل الآن!",
    en: "Al-Mamoura Insulation & General Contracting - Top company for foam insulation, waterproofing, water leak detection without demolition, and tank epoxy insulation in Riyadh, Saudi Arabia.",
  },
  keywords: [
    "شركة عزل أسطح وفوم وكشف تسربات بالرياض",
    "شركة عزل أسطح بالرياض",
    "شركة عزل فوم بالرياض",
    "شركة كشف تسربات المياه بالرياض",
    "شركة عزل خزانات بالرياض",
    "عزل فوم بولي يوريثان بالرياض",
    "كشف تسربات المياه بدون تكسير بالرياض",
    "تقرير معتمد لشركة المياه الوطنية بالرياض",
    "حل مشكلة ارتفاع فاتورة المياه بالرياض",
    "عزل رول ممبرين بيتوميني بالرياض",
    "عزل بولي يوريا بالرياض",
    "ترميم حمامات بالرياض",
    "تجديد حمامات بالرياض",
    "صيانة حمامات بالرياض",
    "ترميم وتجديد حمامات بالرياض",
    "تشطيب حمامات بالرياض",
    "عزل حمامات ومطابخ بالرياض",
    "عزل مسابح بالرياض",
    "عزل خزانات المياه بالإيبوكسي بالرياض",
    "عزل مائي وشينكو بالرياض",
    "سعر متر الفوم بالرياض",
    "أفضل شركة عزل مائي وحراري بالرياض",
    "عزل فوم معتمد من شركة الكهرباء",
    "شركة عوازل بالرياض معتمدة",
    "كشف تسربات المياه في شرق الرياض",
    "كشف تسربات المياه في شمال الرياض",
    "كشف تسربات المياه في غرب الرياض",
    "كشف تسربات المياه في جنوب الرياض",
    "شركة عزل فوم بحي الملقا",
    "شركة عزل فوم بحي النرجس",
    "شركة عزل فوم بحي الياسمين",
    "شركة عزل فوم بحي الصحافة",
    "water leak detection Riyadh",
    "roof insulation Riyadh",
    "foam insulation Riyadh",
    "polyurea coating Riyadh",
    "tank epoxy insulation Riyadh",
  ],
  ...
  services: [
    {
      ...
      ar: "ترميم وتجديد وصيانة حمامات",
      en: "Bathroom Renovation & Maintenance",
      description: {
        ar: "ترميم وتجديد وصيانة حمامات بالرياض مع عزل مائي هندسي قبل وبعد البلاط لمنع التسرب نهائياً",
      },
    },
    {
      id: "membrane-roll",
