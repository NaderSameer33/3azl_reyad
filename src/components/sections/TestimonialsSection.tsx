...
const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    date: "منذ شهر",
    review:
      "كان الخزان الأرضي يعاني من تسرب مياه جوفية ملوثة وشروخ في اللياسة. قام فريق درع الخليج بتفريغ الخزان ومعالجة الشروخ بمواد سيكا غير منكمشة، ثم دهنوا طبقتين إيبوكسي أزرق غذائي معتمد لمياه الشرب. تم تعقيم الخزان بالكامل وتسليمه خالي من أي روائح أو شوائب.",
    highlightMetric: {
